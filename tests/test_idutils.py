...
identifiers = [
    ...
    ('urn:nbn:de:bvb:19-146642', ['urn', ], '',
        'https://nbn-resolving.org/urn:nbn:de:bvb:19-146642'),
    ...
    (u'10.1016/üникóδé-дôΐ', ['doi', 'handle'],
        ...
        u'https://doi.org/10.1016/üникóδé-дôΐ'),
    (u'10.1016/སྦ་བཞེད་', ['doi', 'handle'],
        u'10.1016/སྦ་བཞེད་',
        u'https://doi.org/10.1016/སྦ་བཞེད་'),
    ...
    ('http://hdl.handle.net/10013/epic.10033', ['handle', 'url'],
        '10013/epic.10033', 'https://hdl.handle.net/10013/epic.10033'),
    ...
    ('2016arXiv161002026S', ['ads'], '',
        'https://ui.adsabs.harvard.edu/#abs/2016arXiv161002026S'),
    ...
    ('P02833', ['uniprot', ], '',
        'https://purl.uniprot.org/uniprot/P02833'),
    ('Q9GYV0', ['uniprot', ], '',
    ...
    ('NZ_JXSL01000036.1', ['refseq', ], '',
        ...
        'NZ_JXSL01000036.1'),
    ('NM_206454', ['refseq', ], '',
        'https://www.ncbi.nlm.nih.gov/entrez/viewer.fcgi?val=NM_206454'),
    ('XM_002113800.1', ['refseq', ], '',
        'https://www.ncbi.nlm.nih.gov/entrez/viewer.fcgi?val=XM_002113800.1'),
    ('GCA_000002275.2', ['genome', ], '',
        'https://www.ncbi.nlm.nih.gov/assembly/GCA_000002275.2'),
